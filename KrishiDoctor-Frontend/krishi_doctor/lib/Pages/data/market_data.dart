  ...
  List<VegetablePrice> getMarketPrices() {
    return MarketData.vegetables.map((veg) {
      ...
      return VegetablePrice(
        ...
        currentPrice,
        veg['unit'],
        List<double>.from(veg['priceHistory']),  // Explicitly convert to List<double>
...
class VegetablePrice {
  ...
  final double price;
  final String unit;
  final List<double> priceHistory;  // Changed to List<double>
  final PriceTrend trend;
  final String icon;

  VegetablePrice(this.vegetableName, this.price, this.unit, this.priceHistory, this.trend, this.icon);
}
