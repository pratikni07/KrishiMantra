...
import 'package:krishi_mantra/screens/features/crop_care/widgets/ChatAppBar.dart';
import 'package:krishi_mantra/screens/features/crop_care/widgets/MessageBubble.dart';
import 'package:krishi_mantra/screens/features/crop_care/widgets/MessageInputWidget.dart';
  ...
  bool _validatePoll(TextEditingController questionController,
    ...
    if (validOptions.length < 2) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Please provide at least two poll options')));
      return false;
    }
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (_validatePoll(
                          questionController, _pollOptionControllers)) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return MessageBubble(
                  ...
                  pollWidgetBuilder:
                      message.isPoll ? (msg) => _buildPollWidget(msg) : null,
                );
              },
            ),
          ),
          ...
          if (_showPollOptions) _buildPollCreationWidget(),
