...
// import 'package:krishi_mantra/screens/features/reels/widget/VideoUploadPage.dart';
  ...
  final List<Map<String, String>> reelsData = [
    {
      ...
      'caption':
          'Exploring innovative farming techniques that revolutionize agricultural productivity and sustainability. Learn how modern technology and traditional knowledge can work together to create more efficient and eco-friendly farming practices. 🚜🌱 #ModernFarming #Sustainability #AgriculturalInnovation',
    ...
    },
    {
      ...
      'caption':
          'Organic farming in progress! Discover the secrets of sustainable agriculture and how we can protect our environment while producing nutritious food. 🌾 Follow our journey towards a greener future! #OrganicFarming #Sustainability #EcoAgriculture',
    ...
    _videoController = VideoPlayerController.network(url)
      ..initialize().then((_) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Failed to load video. Check your internet connection.')),
        );
      });
  }
                ...
                child: ListView(
                  children: [
                    ...
                    ListTile(
                      ...
                      subtitle: Text(
                          'छान माहिती दिली आहे! माझ्या शेतीसाठी खूप उपयोगी ठरेल.'),
                    ),
                    ListTile(
                      leading: CircleAvatar(child: Icon(Icons.person)),
                      title: Text('Anish Patil'),
                      subtitle:
                          Text('हे औषध फवारणीसाठी कोणत्या प्रमाणात वापरायचं?'),
                    ),
                  ],
                ),
              ),
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              if (isTextOverflowing)
                                GestureDetector(
                                  onTap: () =>
                                      _showFullCaptionModal(reel['caption']!),
                                  child: Text(
                                    'See More',
                                    style: TextStyle(
