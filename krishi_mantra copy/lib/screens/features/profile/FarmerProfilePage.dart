...
class AppColors {
  ...
  static const Color lightGreen =
      Color(0xFFE8F5E9); // Very light green for backgrounds
  static const Color mediumGreen =
      Color(0xFF81C784); // Medium shade for accents
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Row(
                children: [
                  _buildStatCard(
                      'Rating', '${farmerData['rating']}', Icons.star_rounded),
                  _buildStatCard(
                      'Consultations',
                      '${farmerData['totalConsultations']}',
                      Icons.people_rounded),
                  _buildStatCard('Success Rate', farmerData['successRate'],
                ...
                children: [
                  ...
                  _buildSection(
                    ...
                    [
                      ...
                      _buildInfoTile(
                          'Irrigation System', farmerData['irrigation']),
                    ],
                  ),
                  const Divider(height: 1),
                  _buildSection(
                    ...
                    [
                      Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: (farmerData['mainCrops'] as List)
                            .map(
                              (crop) => Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border:
                                      Border.all(color: AppColors.mediumGreen),
                                ),
                                child: Text(
                                  crop,
                                  style: const TextStyle(
                  ...
                  _buildSection(
                    ...
                    [
                      ...(farmerData['certifications'] as List)
                          .map(
                            (cert) => ListTile(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
                content: Text('Request Consultation Feature Coming Soon!')),
          );
        },
        backgroundColor: AppColors.primaryGreen,
